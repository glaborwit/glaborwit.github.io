...
function changeSlide(dot){
    ...
    if (pic==="img1"){
        ...
        document.getElementById("bun-bun-name").innerHTML="<a href='original-cinnamon.html'>Original Cinnamon Bun Bun</a>";
    ...
    if (pic==="img2"){
        ...
        document.getElementById("bun-bun-name").innerHTML="<a href='walnut.html'>Walnut Bun Bun</a>";
    ...
    if (pic==="img3"){
        ...
        document.getElementById("bun-bun-name").innerHTML="<a href='glutenfree-cinnamon.html'>Gluten-Free Cinnamon Bun Bun</a>";
    ...
    if (pic==="img4"){
        ...
        document.getElementById("bun-bun-name").innerHTML="<a href='caramelpecan.html'>Caramel Pecan Bun Bun</a>";
